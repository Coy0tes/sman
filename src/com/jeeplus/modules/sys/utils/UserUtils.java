...
public class UserUtils {
	...
	private static SiteuserDao siteuserDao = SpringContextHolder.getBean(SiteuserDao.class);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void clearCache(Siteuser user) {
		CacheUtils.remove(USER_CACHE, USER_CACHE_ID_ + user.getId());
		CacheUtils.remove(USER_CACHE, USER_CACHE_LOGIN_NAME_ + user.getLoginName());
	}
	 ...
	 * @return
	 */
	public static Siteuser getSiteUser(String id) {
		User user = new User(id);
		Siteuser suser = new Siteuser();
		suser = siteuserDao.get(id);
		...
		//获取用户角色
		suser.setRoleList(roleDao.findListByUser(new Role(user)));
	 ...
	 * @return
	 */
	public static boolean isSiteUser(String id){
		boolean is = false;
		
		Siteuser suser = new Siteuser();
		suser = siteuserDao.getSiteUser(id);
	 ...
	 * @return
	 */
	public static List<Role> getSiteRoleList() {
		return roleDao.getSiteRoleList(new Role());
	}
}
