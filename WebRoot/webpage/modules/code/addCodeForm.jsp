...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="code" action="${ctx}/code/code/addCodeSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>兑换码数量：</label></td>
					<td class="width-35">
						<form:input path="codenum" htmlEscape="false"    class="form-control required"/>
					</td>
				</tr>
				<tr>
