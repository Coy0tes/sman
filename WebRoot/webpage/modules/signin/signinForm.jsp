...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="signin" action="${ctx}/signin/signin/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr class="shenhe">
					...
					<td class="width-35" colspan="3">
						${signin.shbtgyy}
						<%-- <form:textarea path="shbtgyy" htmlEscape="false"    class="form-control "/> --%>
					</td>
		  		</tr>
		 	</tbody>
		</table>
